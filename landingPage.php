    ...
    <div class="container">
      <div class="container__mainContent">
        ...
        <div class="container__mainContent--destop">
          <div class="container__mainContent__destop--block1">
            <div class="container__mainContent__destop__block1--text">
              <h2>
              ...
              <p>
                Rejoignez dès à présent notre communauté de curieux ! Vous
                souhaitez lire des articles en tous genres et de qualité ? Vous
                souhaitez partager votre expériences et rédiger des articles
          ...
          <h4 class="tirezProfit">
            Tirez profit de ce que MECO a à vous offrir
          </h4>
          ...
          <div class="container__mainContent__destop--block3">
            <h4>
