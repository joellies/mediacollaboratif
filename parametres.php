...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="http://localhost:8000/mediacollaboratif/assets/css/articles.css">
    ...
    <div class="parametres_mainContent">
      ...
      <div class="parametres_userImage">
        <div class="cercle_userImage">
          <img class="userImage" src="http://localhost:8000/mediacollaboratif/assets/images/Jane-Doe.png">
        </div>
        <div class="parametres_modifierImage"> <a href="">Modifier image</a></div>
      </div>
      <div class="parametres_userForm">
        <form class="parametres_form">
          ...
          <div class="parametres_suppression"><a class="link_suppression" href="">Supprimer mon compte</a></div>
          <div class="btn_param">
